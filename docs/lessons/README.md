...
- [gomobile-mobile-bindings.md](gomobile-mobile-bindings.md) - gomobile AAR/XCFramework live mobile proof requires pinned generation, artifact/class/method verification, Android minSdk alignment, and explicit stubs when bindings are absent.

...
- [gomobile-mobile-bindings.md](gomobile-mobile-bindings.md) - gomobile AAR/XCFramework live mobile proof requires pinned generation, artifact/class/method verification, Android minSdk alignment, explicit stubs, and Android remote auto-apply handoff checks.
